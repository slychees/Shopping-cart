<%-- 
    ...
    Created on : May 16, 2021, 11:37:31 AM
    Author     : Sly Cheese
--%>
                        ...
                        <% List cart = (ArrayList) session.getAttribute("cart") ;%>
                            ...
                            <div class="form-group">
                                <div class="col-sm-3 col-xs-3">
                                    <img class="img-responsive" src="img/<%= product.getItem().getImage()  %>" />
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="col-xs-12"><%= product.getItem().getProductname()  %> </div>
                                    <div class="col-xs-12"><small>Quantity:<span><%= product.getQuantity()  %> &nbsp; * &nbsp; Price: £<%=product.getItem().getPrice()  %> </span></small></div>
                                </div>
                                <div class="col-sm-3 col-xs-3 text-right">
                                    <h6><span>£</span><%= product.getQuantity() * product.getItem().getPrice()  %>  </h6>
                                </div>
                            </div>
                                    <% quantity += product.getQuantity(); %>
                                    <% itempurchased += product.getItem().getProductname();  %>
                                    <% price += product.getQuantity() * product.getItem().getPrice(); %>
...
<!--                            <div class="form-group"><hr /></div>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span>£</span><span>${ordertotal}</span></div>
                                </div>
                                <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-submit-fix" onclick="showAlert()">Place Order</button>
                                    ...
                                    <input type="hidden" name="ACTIONS" value="CUSTINFO" > 
                                    </div>
                    <!--REVIEW ORDER END-->
                </div>
